...
- `zqa-gui` remains MIT-licensed. GPUI Kit and the `gpui-pre` snapshot of Zed's GPUI that it
  uses are published under Apache-2.0; Zed's application-level GPL license does not apply to
  those crates.
