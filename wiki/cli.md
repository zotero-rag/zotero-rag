...
[zqa-rag](/rag.md). The CLI streams model text, reasoning summaries (rendered
dimmed), and tool status to the terminal, then accumulates the turn's token usage (including cached-input and
