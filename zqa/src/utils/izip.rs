// We only need the `izip` macro from the `itertools` crate, so we use its implementation directly:
// See https://docs.rs/itertools/latest/itertools/macro.izip.html
#[macro_export]
